    ...
    def SmashInteface(Players, Name1, Name2, Name3, Name4):
        ...
        def player1Tree(Nodo, Objetivo):
            ...
            if Build == Objetivo:
                ...
                Texto = ""
                Elementos1+=1
                message = "El jugador #1 obtuvo un token"
                message = clienteSocket.send(message.encode())
        ...
        def player2Tree(Nodo, Objetivo):
            ...
            if Build == Objetivo:
                ...
                Texto = ""
                Elementos2+=1
                message = "El jugador #2 obtuvo un token"
                message = clienteSocket.send(message.encode())
        ...
        def player3Tree(Nodo, Objetivo):
            ...
            if Build == Objetivo:
                ...
                Texto = ""
                Elementos3+=1
                message = "El jugador #3 obtuvo un token"
                message = clienteSocket.send(message.encode())
        ...
        def player4Tree(Nodo, Objetivo):
            ...
            if Build == Objetivo:
                message = "El jugador #4 obtuvo un token"
                message = clienteSocket.send(message.encode())
